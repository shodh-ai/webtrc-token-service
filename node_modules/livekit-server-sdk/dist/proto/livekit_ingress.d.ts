...
import { AudioCodec, TrackInfo, TrackSource, VideoCodec, VideoLayer } from "livekit-server-sdk/dist/proto/livekit_models";
    ...
    fromPartial<I extends {
        ...
        state?: ({
            ...
            tracks?: ({
                ...
                } & { [K_12 in Exclude<keyof I["state"]["tracks"][number]["codecs"][number], keyof import("livekit-server-sdk/dist/proto/livekit_models").SimulcastCodecInfo>]: never; })[] & { [K_13 in Exclude<keyof I["state"]["tracks"][number]["codecs"], number | keyof {
                    mimeType?: string | undefined;
                    mid?: string | undefined;
                    cid?: string | undefined;
                    layers?: {
...
export declare const IngressState: {
    ...
    fromPartial<I extends {
        ...
        tracks?: ({
            ...
            } & { [K_6 in Exclude<keyof I["tracks"][number]["codecs"][number], keyof import("livekit-server-sdk/dist/proto/livekit_models").SimulcastCodecInfo>]: never; })[] & { [K_7 in Exclude<keyof I["tracks"][number]["codecs"], number | keyof {
                mimeType?: string | undefined;
                mid?: string | undefined;
                cid?: string | undefined;
                layers?: {
        ...
        items?: ({
            ...
            state?: ({
                ...
                tracks?: ({
                    ...
                    } & { [K_12 in Exclude<keyof I["items"][number]["state"]["tracks"][number]["codecs"][number], keyof import("livekit-server-sdk/dist/proto/livekit_models").SimulcastCodecInfo>]: never; })[] & { [K_13 in Exclude<keyof I["items"][number]["state"]["tracks"][number]["codecs"], number | keyof {
                        mimeType?: string | undefined;
                        mid?: string | undefined;
                        cid?: string | undefined;
                        layers?: {
